    ...
    fetch("/yonetim/bildirim-yenile/")
      ...
      .then(function (data) {
        ...
        notifications.map((items) => {
          if (items["n_type"] == "1") {
          ...
          } else if (items["n_type"] == "8") {
            var item = `
                     <a href="/yonetim/bildirim-goruntule/bildirim_id=${items["id"]}/" data-id = "${items["id"]}" class="dropdown-item dropdown-item-unread">
            ...
            `                
          }else if (items["n_type"] == "9") {
            var item = `
                     <a href="/yonetim/kullanici-yonetimi/gorevler/gorev-detay/gorev_id=${items["id"]}/" data-id = "${items["id"]}" class="dropdown-item dropdown-item-unread">
                                <div class="dropdown-item-icon bg-warning text-white">
