...
class ProductIntegrationService(BaseService):
    ...
    def create_products(self, items, supplier_id=None):
        if supplier_id:
            endpoint = "suppliers/{}/v2/products".format(supplier_id)
        else:
            endpoint = "suppliers/{}/v2/products".format(self._api.supplier_id)
        url = urljoin(self.base_url, endpoint)
        ...
        data = self._api.call("POST", url, params=params, headers=headers, files=None)
        return data

    def update_products(self, items, supplier_id=None):
        if supplier_id:
            endpoint = "suppliers/{}/v2products".format(supplier_id)
        else:
            endpoint = "suppliers/{}/v2/products/".format(self._api.supplier_id)
        url = urljoin(self.base_url, endpoint)
        params = {
    ...
    def deleted_products(self, items, supplier_id=None):
        if supplier_id:
            endpoint = "suppliers/{supplier_id}/v2/products".format(
                supplier_id=supplier_id
            )
        else:
            endpoint = "suppliers/{supplier_id}/v2/products".format(
        ...
        data = self._api.call("DELETE", url, params=params, headers=None, files=None)
        return data
