    ...
    if trendyol_category:
        ...
        for p in products:
            ...
            for a in attributes:
                ...
                if category_title == "Fantezi Babydoll" or category_title == "Fantezi Gecelik" or category_title == "Fantezi İç Çamaşır Takımları" or category_title == "Fantezi Külot" or category_title == "Fantezi Sütyen" or category_title == "Gecelik" or category_title == "Jartiyer" or category_title == "Külot" or category_title == "Sütyen" or category_title == "Çorap":
                    if a['attribute']['name'] == 'Beden':
                        if p.size:
                            for s in a['attributeValues']:
                                if p.size.name.lower() == s['name'].lower():
