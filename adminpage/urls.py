...
urlpatterns = [
    ...
    path('trendyol/komisyon-oranlari/hepsini-sil/', trendyol_komisyon_hepsini_sil,
         name='trendyol_komisyon_hepsini_sil'),
    path('trendyol/komisyon-oranlari/export-excel/', trendyol_komisyon_export_excel,
         name='trendyol_komisyon_export_excel'),
    path('trendyol/komisyon-oranlari/export-pdf/', trendyol_komisyon_export_pdf,
         name='trendyol_komisyon_export_pdf'),
    ...
    path('harcamalar/export-pdf/', harcamalar_export_pdf,
